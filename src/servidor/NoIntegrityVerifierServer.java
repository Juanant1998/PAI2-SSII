...
public class NoIntegrityVerifierServer extends Thread {
	...
	public NoIntegrityVerifierServer(final BigDecimal bkey) throws Exception {
			...
			try {
				...
				if (!this.nonceUsados.contains(nonce)) {
					...
					if (macdelMensajeEnviado.equals(CalculatorMac.mac(mensaje, nonce, DHKey))) {
						...
						// MAN IN THE MIDDLE para modificar la respuesta del servidor al cliente
						this.mensajeOK = "FALLO. Vuelva a intentarlo, por favor.";
